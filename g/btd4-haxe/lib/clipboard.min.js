! function(a, b) {
    ...
    return a.copy = function() {
        function d() {
            a = !1, b = null, c && window.getSelection().removeAllRanges(), c = !1
        }

        function e() {
            var a = document.getSelection();
            if (!document.queryCommandEnabled("copy") && a.isCollapsed) {
                var b = document.createRange();
                b.selectNodeContents(document.body), a.removeAllRanges(), a.addRange(b), c = !0
            }
        }
        var a = !1,
            b = null,
        ...
        return document.addEventListener("copy", function(c) {
                if (a) {
                    for (var d in b) c.clipboardData.setData(d, b[d]);
                    c.preventDefault()
                }
            }),
            function(c) {
                return new Promise(function(f, g) {
                    function h(a) {
                        try {
                            if (document.execCommand("copy")) d(), f();
                            else {
                                if (a) throw d(), new Error("Unable to copy. Perhaps it's not available in your browser?");
                                e(), h(!0)
                            }
                        } catch (a) {
                            d(), g(a)
        ...
        return document.addEventListener("paste", function(d) {
                if (a) {
                    a = !1, d.preventDefault();
                    var e = b;
                    b = null, e(d.clipboardData.getData(c))
                }
            }),
            function(d) {
                return new Promise(function(e, f) {
                    a = !0, b = e, c = d || "text/plain";
                    try {
                        document.execCommand("paste") || (a = !1, f(new Error("Unable to paste. Pasting only works in Internet Explorer at the moment.")))
                    } catch (b) {
                        a = !1, f(new Error(b))
                    }
                })
        ...
        return new Promise(function(b, c) {
            if ("string" != typeof a && !("text/plain" in a)) throw new Error("You must provide a text/plain type.");
