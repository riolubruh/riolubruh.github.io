! function() {
    ...
    e.prototype = {
        init: function() {
            var e = this || n;
            return e._counter = 1e3, e._codecs = {}, e._howls = [], e._muted = !1, e._volume = 1, e._canPlayEvent = "canplaythrough", e._navigator = "undefined" != typeof window && window.navigator ? window.navigator : null, e.masterGain = null, e.noAudio = !1, e.usingWebAudio = !1, e.autoSuspend = !0, e.ctx = null, e.mobileAutoEnable = !0, e._setup(), e
        },
        volume: function(e) {
            var t = this || n;
        ...
        _setup: function() {
            var e = this || n;
            if (e.state = e.usingWebAudio && e.ctx && e.ctx.state || "running", e._autoSuspend(), !e.usingWebAudio)
        ...
        _enableMobileAudio: function() {
            ...
            if (!e._mobileEnabled && e.usingWebAudio && (t || o)) {
        ...
        _autoSuspend: function() {
            var e = this;
            if (e.autoSuspend && e.usingWebAudio && void 0 !== e.ctx.suspend && n.usingWebAudio) {
        ...
        _autoResume: function() {
            var e = this;
            if (e.usingWebAudio && void 0 !== e.ctx.resume && n.usingWebAudio) return "running" === e.state && e._suspendTimer ? (clearTimeout(e._suspendTimer), e._suspendTimer = null) : "suspended" === e.state ? (e.ctx.resume().then(function() {
                e.state = "running";
    ...
    t.prototype = {
        init: function(e) {
            ...
            return n.ctx || _(), t._autoplay = e.autoplay || !1, t._format = "string" != typeof e.format ? e.format : [e.format], t._html5 = e.html5 || !1, t._muted = e.mute || !1, t._loop = e.loop || !1, t._pool = e.pool || 5, t._preload = "boolean" != typeof e.preload || e.preload, t._rate = e.rate || 1, t._sprite = e.sprite || {}, t._src = "string" != typeof e.src ? e.src : [e.src], t._volume = void 0 !== e.volume ? e.volume : 1, t._xhrWithCredentials = e.xhrWithCredentials || !1, t._duration = 0, t._state = "unloaded", t._sounds = [], t._endTimers = {}, t._queue = [], t._playLock = !1, t._onend = e.onend ? [{
                ...
                fn: e.onseek
            }] : [], t._onresume = [], t._webAudio = n.usingWebAudio && !t._html5, n.usingWebAudio && n.ctx && n.mobileAutoEnable && n._enableMobileAudio(), n._howls.push(t), t._autoplay && t._queue.push({
                event: "play",
                action: function() {
                    t.play()
                }
                ...
                for (var r = 0; r < e._src.length; r++) {
                    ...
                    if (e._format && e._format[r]) u = e._format[r];
                        ...
                        if ("string" != typeof(i = e._src[r])) {
                            ...
                            continue
                        }(u = /^data:audio\/([^;,]+);/i.exec(i)) || (u = /\.([^.]+)$/.exec(i.split("?", 1)[0])), u && (u = u[1].toLowerCase())
                    }
        ...
        play: function(e, t) {
            ...
            var a = r ? o._soundById(r) : o._inactiveSound();
            if (!a) return null;
            if (r && !e && (e = a._sprite || "__default"), "loaded" !== o._state) {
            ...
            if (r && !a._paused) return t || setTimeout(function() {
                o._emit("play", a._id)
            }, 0), a._id;
            o._webAudio && n._autoResume();
            var i = o._sprite[e],
                d = Math.max(0, a._seek > 0 ? a._seek : i[0] / 1e3),
                _ = Math.max(0, (i[0] + i[1]) / 1e3 - d),
                s = 1e3 * _ / Math.abs(a._rate);
            a._paused = !1, a._ended = !1, a._sprite = e, a._seek = d, a._start = i[0] / 1e3, a._stop = (i[0] + i[1]) / 1e3, a._loop = !(!a._loop && !i[2]);
            var l = a._node;
            if (o._webAudio) {
                var c = function() {
                    o._refreshBuffer(a);
                    var e = a._muted || o._muted ? 0 : a._volume;
                    l.gain.setValueAtTime(e, n.ctx.currentTime), a._playStart = n.ctx.currentTime, void 0 === l.bufferSource.start ? a._loop ? l.bufferSource.noteGrainOn(0, d, 86400) : l.bufferSource.noteGrainOn(0, d, _) : a._loop ? l.bufferSource.start(0, d, 86400) : l.bufferSource.start(0, d, _), s !== 1 / 0 && (o._endTimers[a._id] = setTimeout(o._ended.bind(o, a), s)), t || setTimeout(function() {
                        o._emit("play", a._id)
                    }, 0)
                };
                "running" === n.state ? c() : (o.once("resume", c), o._clearTimer(a._id))
            } else {
                var f = function(e) {
                        l.currentTime = d, l.muted = a._muted || o._muted || n._muted || l.muted, l.volume = a._volume * n.volume(), l.playbackRate = a._rate, e && e !== 1 / 0 && (o._endTimers[a._id] = setTimeout(o._ended.bind(o, a), e));
                        try {
                            var r = l.play();
                            if ("undefined" != typeof Promise && r instanceof Promise && (o._playLock = !0, r.then(function() {
                                    o._playLock = !1, o._loadQueue()
                                })), l.paused) return void o._emit("playerror", a._id, "Playback was unable to start. This is most commonly an issue on mobile devices where playback was not within a user interaction.");
                            t || o._emit("play", a._id)
                        } catch (e) {
                            o._emit("playerror", a._id, e)
                        }
                    },
                    p = window && window.ejecta || !l.readyState && n._navigator.isCocoonJS;
                if (4 === l.readyState || p) f(s);
                else {
                    var m = function() {
                        f(s), l.removeEventListener(n._canPlayEvent, m, !1)
                    };
                    l.addEventListener(n._canPlayEvent, m, !1), o._clearTimer(a._id)
                }
            }
            return a._id
        },
        ...
        volume: function() {
            ...
            for (var u = 0; u < t.length; u++)(o = r._soundById(t[u])) && (o._volume = e, a[2] || r._stopFade(t[u]), r._webAudio && o._node && !o._muted ? o._node.gain.setValueAtTime(e, n.ctx.currentTime) : o._node && !o._muted && (o._node.volume = e * n.volume()), r._emit("volume", o._id));
            return r
        },
        ...
        rate: function() {
            ...
            for (var u = 0; u < t.length; u++)
                if (o = r._soundById(t[u])) {
                    o._rateSeek = r.seek(t[u]), o._playStart = r._webAudio ? n.ctx.currentTime : o._playStart, o._rate = e, r._webAudio && o._node && o._node.bufferSource ? o._node.bufferSource.playbackRate.setValueAtTime(e, n.ctx.currentTime) : o._node && (o._node.playbackRate = e);
                    var i = r.seek(t[u]),
                        d = 1e3 * ((r._sprite[o._sprite][0] + r._sprite[o._sprite][1]) / 1e3 - i) / Math.abs(o._rate);
                    !r._endTimers[t[u]] && o._paused || (r._clearTimer(t[u]), r._endTimers[t[u]] = setTimeout(r._ended.bind(r, o), d)), r._emit("rate", o._id)
                }
            return r
        },
        seek: function() {
            ...
            if (a) {
                if (!("number" == typeof e && e >= 0)) {
                    if (o._webAudio) {
                        var u = o.playing(t) ? n.ctx.currentTime - a._playStart : 0,
                            i = a._rateSeek ? a._rateSeek - a._seek : 0;
                        return a._seek + (i + u * Math.abs(a._rate))
                    }
        ...
        unload: function() {
            for (var e = this, t = e._sounds, o = 0; o < t.length; o++) {
                if (t[o]._paused || e.stop(t[o]._id), !e._webAudio) /MSIE |Trident\//.test(n._navigator && n._navigator.userAgent) || (t[o]._node.src = "data:audio/wav;base64,UklGRigAAABXQVZFZm10IBIAAAABAAEARKwAAIhYAQACABAAAABkYXRhAgAAAAEA"), t[o]._node.removeEventListener("error", t[o]._errorFn, !1), t[o]._node.removeEventListener(n._canPlayEvent, t[o]._loadFn, !1);
        ...
        _emit: function(e, n, t) {
            for (var o = this["_on" + e], r = o.length - 1; r >= 0; r--) {
                var a = o[r];
                a.id && a.id !== n && "load" !== e || (setTimeout(function(e) {
                    e.call(this, n, t)
                }.bind(this, a.fn), 0), a.once && this.off(e, a.fn, a.id))
            }
            return this
        },
        _loadQueue: function() {
        ...
        _ended: function(e) {
            ...
            return t._webAudio && !r && (e._paused = !0, e._ended = !0, e._seek = e._start || 0, e._rateSeek = 0, t._clearTimer(e._id), t._emit("stop", e._id), t._cleanBuffer(e._node), n._autoSuspend()), t._webAudio || r || t.stop(e._id), t
        },
    ...
    o.prototype = {
        ...
        _loadListener: function() {
            ...
            }), "loaded" !== e._state && (e._state = "loaded", e._emit("load"), e._loadQueue()), this._node.removeEventListener(n._canPlayEvent, this._loadFn, !1)
        }
    };
    var r = {},
        a = function(e) {
            ...
            if (/^data:[^;]+;base64,/.test(n)) {
                ...
                _.open("GET", n, !0), _.withCredentials = e._xhrWithCredentials, _.responseType = "arraybuffer", _.onload = function() {
                    var n = (_.status + "")[0];
                    "0" === n || "2" === n || "3" === n ? i(_.response, e) : e._emit("loaderror", null, "Failed loading audio file with status: " + _.status + ".")
                }, _.onerror = function() {
        ...
        _ = function() {
            try {
                "undefined" != typeof AudioContext ? (n.ctx = new AudioContext, n.usingWebAudio = !0) : "undefined" != typeof webkitAudioContext ? (n.ctx = new webkitAudioContext, n.usingWebAudio = !0) : (n.ctx = "DISABLED", n.usingWebAudio = !1)
            } catch (e) {
                n.usingWebAudio = !1
            }
            ...
            n.usingWebAudio && (n.dynamicsCompressorNode = n.ctx.createDynamicsCompressor(), n.dynamicsCompressorNode.connect(n.ctx.destination), n.masterGain = void 0 === n.ctx.createGain ? n.ctx.createGainNode() : n.ctx.createGain(), n.masterGain.gain.setValueAtTime(n._muted ? 0 : 1, n.ctx.currentTime), n.masterGain.connect(n.dynamicsCompressorNode)), n._setup()
        };
