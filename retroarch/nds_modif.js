...
function createWasm() {
  ...
  //if(true)){
    console.log("running");
    alert("running");
    import decodedSample from 'nds_wasm'; // nds_wasm.js contains the bundled .wasm
    return WebAssembly.instantiateStreaming(decodedSample).then(obj => obj.instance.exports.exported_func()).then(function(instance){
			return instance
		});
